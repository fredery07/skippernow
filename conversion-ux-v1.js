(function(){
  ...
  function installHomeConversion(){
    ...
    style.textContent = `
      .sn-home-choice-shell{max-width:1180px;margin:22px auto 8px;padding:0 24px;position:relative;z-index:6}
      ...
      @media(max-width:760px){.sn-home-choice-shell{padding:0 14px;margin-top:14px}.sn-home-choice{padding:18px}.sn-home-choice-grid{grid-template-columns:1fr}.sn-home-choice-card{min-height:120px}.sn-home-choice-head h2{font-size:23px}.sn-home-reassurance{justify-content:flex-start;gap:9px 14px}}
    `;
